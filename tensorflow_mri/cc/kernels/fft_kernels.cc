...
limitations under the License.
==============================================================================*/
// This file is inspired by "tensorflow/tensorflow/core/kernels/fft_ops.cc",
// but CPU kernels have been modified to use the FFTW library. The original
// GPU kernels have been removed.
