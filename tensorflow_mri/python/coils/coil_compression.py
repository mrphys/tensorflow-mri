...
def compress_coils(kspace,
                   ...
                   method='svd',
                   **kwargs):
  """Compresses a multicoil *k*-space/image array.
  ...
  calibrate the compression using different data, use one of the compressor
  classes instead.
...
@api_util.export("coils.compress_coils_universal")
def compress_coils_universal(
    meas_data,
    operator,
    calib_data=None,
    calib_fn=None,
